...
#         eye_reg = l1_norm_x + torch.sqrt(l1_norm_x**2 + l2_norm_c + l2_norm_s)
#         return self.lambda_eye_known * l2_norm_c + self.lambda_eye_unknown * l1_norm_x + self.lambda_eye_shortcut * l2_norm_s
